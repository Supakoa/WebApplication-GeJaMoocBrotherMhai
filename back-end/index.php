...
<body>
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          <li class="nav-item">
            <a class="nav-link" href="#" onclick="call_content('test')">
      ...
      <div class="main-panel" >
        <div class="content-wrapper" id="indexcontent">
          หฟกดฟหด
        </div>
  ...
  <!-- on load index content -->
  <script src="node_modules/jquery/dist/jquery.min.js"></script>
  <script>
    $(document).ready(function () {
      $( "#indexcontent" ).load( "pages/main/index.php");
    });
    function call_content(folder){
      $("#indexcontent").load("pages/" + folder + "/index.php");
    }
  </script>
